...
이 빌더는 귀사가 선택한 네트워크에 맞춰 [**1.2 요구사항 및 사용권한**](1.2.md) **부터 \~** [**1.5 SDK 연동 키 설정**](https://adwhale.gitbook.io/adwhale-mediation-sdk-android/~/revisions/DojBGU1CYqXUEm9bgTbS/android/sdk/1./1.4-sdk) **단계 까지 필요한 모든 설정 코드를 자동으로 생성**합니다.&#x20;

...
* 코드블록 삭제 후, 이어서 [**ADwhale SDK 추가하기**](1.3-build.gradle.md#adwhale-sdk-1)를 진행
* [**dependencies 설정**](1.3-build.gradle.md#dependencies)을 참고하여 ADwhale SDK를 **최신 버전(2.5.9 이상)** 으로 업데이트
{% endhint %}

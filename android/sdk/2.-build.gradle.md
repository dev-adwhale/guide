...
dependencies {
    ...
    implementation 'net.adwhale.sdk.mediation:adwhale-mediation-sdk:2.5.3'
    ...
    implementation 'net.adwhale.sdk.admize.adapter:admize-sdk:1.0.4'

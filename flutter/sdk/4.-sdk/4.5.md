...
```dart
Future<void> setAppMuted(bool isMuted) async
...
<pre class="language-dart"><code class="lang-dart">// 앱 시작 시 또는 광고 초기화 시 1회 설정 
<strong>await AdWhaleMediationAds.instance.setAppMuted(false);
</strong>await AdWhaleMediationAds.instance.setAppVolume(0.3);
</code></pre>

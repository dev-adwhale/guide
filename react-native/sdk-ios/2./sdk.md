...
<strong>source 'https://github.com/dev-adwhale/AdWhaleSDK_iOS.git'
</strong>
...
{% hint style="danger" %}
React Native(bare) 환경에서 iOS 앱을 App Store에 배포할 때, 다음과 같은 에러가 발생할 수 있습니다.
...
\
이 경우 Podfile에서 Hermes 엔진을 비활성화합니다.
...
{% content-ref url="/broken/pages/KRuU06UmcHytrLv1jW8r" %}
[Broken link](/broken/pages/KRuU06UmcHytrLv1jW8r)
{% endcontent-ref %}

...
**접속링크:** [https://cdn.fsn.co.kr/guide/sdk/adwhale/adwhale-mediation-guide(ko).html](https://cdn.fsn.co.kr/guide/sdk/adwhale/adwhale-mediation-guide\(ko\).html)
{% endtab %}
...
target 'Runner' do
  ...
  # AdMob Mediation: 필요한 네트워크만 주석 해제하여 사용 (Google-Mobile-Ads-SDK ~> 13.x 호환)
...
* **ADwhale Mediation SDK 가 사용하는 애드몹 버전: 24.3.0**



**iOS**

* 이 플러그인은 iOS에서 **ADwhale Mediation SDK**를 CocoaPods로 가져옵니다.
* **ADwhale Mediation SDK 가 사용하는 애드몹 버전: 13.0.0**

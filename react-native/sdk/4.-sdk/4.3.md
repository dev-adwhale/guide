...
<table data-header-hidden><thead><tr><th width="348">파라미터 타입</th><th>파라미터 값</th></tr></thead><tbody><tr><td>파라미터 타입</td><td>파라미터 값</td></tr><tr><td>boolean</td><td>true : 광고 요청이 EEA에 거주하는 동의 연령 미만의 사용자를 대상으로 처리하도록 지정하는 경우<br>false : 동의 연령 미만 여부를 지정하지 않음</td></tr></tbody></table>
...
```typescript
setMaxAdContentRating(rating: String)
```
